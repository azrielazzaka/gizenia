...
<style>
    ...
    #api-col-sidebar::-webkit-scrollbar { width: 4px; }
    #api-col-sidebar::-webkit-scrollbar-thumb { background: #333; border-radius: 2px; }
    ...
    .col-item:hover { background: #222; color: #eee; }
    .col-item.selected { background: #1a2a22; color: #22d47a; }
    ...
    .badge-GET    { background: #0d3320; color: #22d47a; }
    .badge-POST   { background: #0d1a33; color: #4d8eff; }
    .badge-PUT    { background: #332200; color: #ffb627; }
    .badge-DELETE { background: #330d11; color: #ff4d6a; }
    ...
    #api-send-btn:hover { opacity: 0.85; }
    ...
    #api-response::-webkit-scrollbar { width: 4px; }
    #api-response::-webkit-scrollbar-thumb { background: #333; border-radius: 2px; }
    ...
    /* ===== SYNTAX HIGHLIGHT ===== */
    .jk { color: #4d8eff; }   /* key */
    .js { color: #22d47a; }   /* string */
    .jn { color: #ffb627; }   /* number */
    .jb { color: #ff4d6a; }   /* boolean / null */
</style>
...
<div style="display:flex; height:100%; overflow:hidden;">
    ...
    <div id="api-col-sidebar">
        <div style="padding:12px 12px 8px; font-size:10px; color:#444; text-transform:uppercase; letter-spacing:0.6px; border-bottom:1px solid #2a2a35;">
            Collection
        </div>
        <div id="col-list"></div>
    </div>
